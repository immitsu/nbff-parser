...
describe('parse', () => {
  describe('fragments', () => {
    describe('BOOKMARK', () => {
      ...
      test('with id', () => {
        const actual = parse(BOOKMARK, { withId: true })
      ...
      test('with excluded attrs', () => {
        ...
        const { icon, previewsize, ...anotherResult } = result

        const actual = parse(BOOKMARK, { excludeAttrs })
      ...
      test('lower case', () => {
        const initial = BOOKMARK.toLowerCase()
